...
segs = tif.imread('labels_after_automatic_segmentation_multi.tif')
gt = tif.imread('groundtruth_multi.tif')


proofreads = '/tmp/S62tif/' # folder of tif file (1 per slice) 0.tif .. 9.tif
